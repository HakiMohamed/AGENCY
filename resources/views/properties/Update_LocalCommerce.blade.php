...
<div class=" container  mt-4 py-5" >
    <h1 class="fw-bold mb-5 px-4"  style="color: #00B98E;">Editer votre Appartement, Bureau, Studio </h1>
    <div class="row mx-3 ">
           @if ($errors->any())
...
@endif
        ...
        <div class="col-md-6 " >
            ...
            <form  enctype="multipart/form-data" id="uploadForm" action="{{ route('localcommerces.StoreUpdate',$property->id) }}" method="POST">
                ...
                <div class="mb-3 ">
                    ...
                    <select style="background-color: rgba(248, 247, 249, 0.719);"class="form-select" id="type" name="type_id" required>
                        <option  selected value="5">Local Commerce</option>
                    </select>
