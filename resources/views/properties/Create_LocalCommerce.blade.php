...
<div class=" container  mt-4 py-5" >
    <h1 class="fw-bold px-4">Publier vos locla Commerce  </h1>
        ...
        <div class="col-md-6">
            ...
            <form enctype="multipart/form-data" id="uploadForm">
                <div class="mb-3 py-3">
                    ...
                    <input style="background-color: rgba(248, 247, 249, 0.719);"type="text" class="form-control" id="title" placeholder="Exemple: Local Commerce à vendre Casablanca - Beauséjour" name="title" required>
                </div>

                <div class="mb-3 py-3">
                    <label for="description" class="form-label fw-bold">Description</label>
                    <textarea style="background-color: rgba(248, 247, 249, 0.719);"class="form-control" placeholder="Exemple: Serraj immobilier vous propose un magasin à vendre idéalement placé .--La Superficie du RDCH =79m2-Superficie du mezzanine =79 m2-Total RDCH + 50% de mezzanine = 118.50 m2--Pour plus d'informations contactez nous" id="description" name="description" required></textarea>
                </div>
