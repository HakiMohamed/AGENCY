...
<div class=" container  mt-4 py-5" >
    <h1 class="fw-bold px-4">Publier votre Maison, Riad, Villa </h1>
        ...
        <div class="col-md-6">
            ...
            <form enctype="multipart/form-data" id="uploadForm">
                <div class="mb-3 py-3">
                    ...
                    <input style="background-color: rgba(248, 247, 249, 0.719);"type="text" class="form-control" id="title" placeholder="Exemple: Maison, Riad, Villa à vendre Casablanca - bernoussi" name="title" required>
                </div>

                <div class="mb-3 py-3">
                    <label for="description" class="form-label fw-bold">Description</label>
                    <textarea style="background-color: rgba(248, 247, 249, 0.719);"class="form-control" placeholder="Exemple: Bienvenue dans cette belle villa,Maison,Riad offrant une surface généreuse de 160m2, dont 100m2 construits, dans l'un des quartiers les plus prisés de Casablanca. Cette propriété regorge de potentiel et n'attend que votre touche personnelle" id="description" name="description" required></textarea>
                </div>
